...
class meArm():
    value = 0
    def __init__(self,
            sweepMinBase     = 215, sweepMaxBase     = 512, angleMinBase     =  1.22, angleMaxBase     = -1.22,
            sweepMinShoulder = 108, sweepMaxShoulder = 435, angleMinShoulder =  2.16,  angleMaxShoulder =  0.35,
            sweepMinElbow    = 553, sweepMaxElbow    = 266, angleMinElbow    =  0.24, angleMaxElbow    = -1.05,
            sweepMinGripper  = 342, sweepMaxGripper  = 102, angleMinGripper  =  -0.79, angleMaxGripper  =  0.79):
