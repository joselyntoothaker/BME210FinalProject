...
class meArm():
    value = 0
    def __init__(self,
            sweepMinBase     = 82, sweepMaxBase     = 430, angleMinBase     =   1.57, angleMaxBase     = -1.57,
            sweepMinShoulder = 113, sweepMaxShoulder = 338, angleMinShoulder =   2.01, angleMaxShoulder =  0.14,
            sweepMinElbow    = 512, sweepMaxElbow    = 328, angleMinElbow    =   0.26, angleMaxElbow    = -0.96,
            sweepMinGripper  = 256, sweepMaxGripper  = 82, angleMinGripper  =   -0.79, angleMaxGripper  =  0.79):
