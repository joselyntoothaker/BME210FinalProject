...
class meArm():
    value = 0
    def __init__(self,
            sweepMinBase     = 123, sweepMaxBase     = 471, angleMinBase     =  1.52, angleMaxBase     = -1.52,
            sweepMinShoulder = 102, sweepMaxShoulder = 369, angleMinShoulder =  2.09,  angleMaxShoulder =  0.52,
            sweepMinElbow    = 307, sweepMaxElbow    = 369, angleMinElbow    = -1.22, angleMaxElbow    = -0.79,
            sweepMinGripper  = 410, sweepMaxGripper  = 205, angleMinGripper  =  -0.79, angleMaxGripper  = 0.79):
