...
class WhiteBall:
    ...
    def __init__(self):
        ...
        self.__blur_radius = 6.0

        self.blur_output = None

         # Go after colored object
        self.__hsv_threshold_input = self.blur_output
        self.__hsv_threshold_hue = [92,131.0]
        self.__hsv_threshold_saturation = [23, 155.]
        self.__hsv_threshold_value = [165, 255.0]
        ...
        self.__filter_contours_min_area = 97.0
        self.__filter_contours_min_perimeter = 53.0
        self.__filter_contours_min_width = 14
        self.__filter_contours_max_width = 80
        self.__filter_contours_min_height = 14
        self.__filter_contours_max_height = 52
        self.__filter_contours_solidity = [86, 100]
        self.__filter_contours_max_vertices = 100
        self.__filter_contours_min_vertices = 10
        self.__filter_contours_min_ratio = 0
        self.__filter_contours_max_ratio = 3
